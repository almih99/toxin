...
(function($){
    ...
    var _renderPie = function (canvas, settings){
        ...
        var angle = settings.angle; // + Math.PI/2;
        var j = settings.sliceIndex;
        ...
        if (settings.fontSize > 0)
        {
           ...
           var whole = Math.floor(slice.amount);
    ...
    var _rotatePie = function (canvas, sliceIndex) {
        ...
        var angle = settings.slices[settings.sliceIndex].radians;
        ...
        var deltaFontSize;
        var deltaPercentage;
        var rotateClockwise = true;// sliceIndex > settings.sliceIndex;
